                    ...
                    switch (operation) {
                        case 'create':
                            const createData = {
                                ...
                                parentId: this.getNodeParameter('parentId', i) || undefined,
                            };
                        ...
                        case 'update':
                            const updateData = {
                                ...
                                code: this.getNodeParameter('code', i, undefined),
                                name: this.getNodeParameter('name', i, undefined),
                                type: this.getNodeParameter('type', i, undefined),
                                parentId: this.getNodeParameter('parentId', i, undefined),
                            };
                            result = await tool.updateAccount(updateData);
                            break;
                        case 'get':
                            result = await tool.getAccountById({ id: this.getNodeParameter('id', i) });
                            break;
                        case 'list':
                            result = await tool.listAccounts({});
                            break;
                        case 'delete':
                            result = await tool.deleteAccount({ id: this.getNodeParameter('id', i) });
                            break;
                    }
                }
                    ...
                    switch (operation) {
                        case 'createEntry':
                            const entryData = {
                                ...
                                reference: this.getNodeParameter('reference', i, undefined),
                                lines: this.getNodeParameter('lines', i),
                            };
                            result = await tool.createJournalEntry(entryData);
                            break;
                        case 'deleteEntry':
                            result = await tool.deleteJournalEntry({ id: this.getNodeParameter('id', i) });
                            break;
                        case 'getEntry':
                            result = await tool.getJournalEntryById({ id: this.getNodeParameter('id', i) });
                            break;
                        case 'searchEntries':
                            result = await tool.searchJournalEntries({});
                            break;
                        case 'getEntryDetails':
                            result = await tool.getJournalEntryDetails({ id: this.getNodeParameter('id', i) });
                            break;
                    }
                }
...
//# sourceMappingURL=LojikAccounting.node.js.map