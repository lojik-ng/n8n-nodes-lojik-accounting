...
export const balanceGroupSchema = z.object({
    ...
    accounts: z.array(z.object({ account: accountSchema, totalDebit: z.number(), totalCredit: z.number(), net: z.number() })),
    parentSubtotals: z
...
export const envelopeOk = (inner) => z.object({ success: z.literal(true), data: inner });
